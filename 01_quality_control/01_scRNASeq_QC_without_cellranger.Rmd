...
cutoffs_low <- c(nGene_cutoff, nUMI_cutoff, 0); cutoffs_high <- c(Inf, Inf, percent.mito_cutoff); ## Manually adjust them accordingly.
cutoffs_low[1] <- max(nGene_cutoff, 50); cutoffs_low[2] <- max(nUMI_cutoff, 100); cutoffs_high[3] <- min(percent.mito_cutoff, 0.8);
